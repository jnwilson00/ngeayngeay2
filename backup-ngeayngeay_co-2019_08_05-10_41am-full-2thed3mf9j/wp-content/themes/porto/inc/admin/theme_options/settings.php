		...
		public function setSections() {
			...
			$this->sections[] = array(
				...
				'fields'     => array(
					...
					array(
						...
						'type'    => 'switch',
						'title'   => __( 'Show WPML Currency Switcher HTML', 'porto' ),
						'desc'    => __( 'Show wpml currency switcher html code if there isn\'t any switcher.', 'porto' ),
						'default' => false,
						'on'      => __( 'Yes', 'porto' ),
						'off'     => __( 'No', 'porto' ),
					),
			...
			$this->sections[] = array(
				...
				'fields'     => array(
					...
					array(
						'title'    => __( 'Variation Selection Mode', 'porto' ),
