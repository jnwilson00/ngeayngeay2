...
final class MonsterInsights_Report_Page_Insights extends MonsterInsights_Report {
	...
	public function get_data( $args = array() ) {
		...
		$check_cache = MonsterInsights_Page_Insights_Cache::get_instance()->get( $this->path );
	...
	public function get_path_by_post_id( $post_id ) {
		...
		if ( ! isset( $this->path ) ) {
			...
			$this->path      = apply_filters( 'monsterinsights_pageinsights_path', $permalink_parts['path'], $post_id );
		}
