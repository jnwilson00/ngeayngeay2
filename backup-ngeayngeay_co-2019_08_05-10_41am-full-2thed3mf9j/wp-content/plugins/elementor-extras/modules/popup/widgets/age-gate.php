...
class Age_Gate extends Extras_Widget {
	...
	public function render_body() {
		...
		?><div <?php echo $this->get_render_attribute_string( 'content-body' ) ; ?>>
			<?php $this->render_denied(); ?>
						...
						<button <?php echo $this->get_render_attribute_string( 'field-submit' ) ; ?>>
							<span>
								<?php if ( ! empty( $settings['button_icon'] ) ) : ?>
									<span <?php echo $this->get_render_attribute_string( 'field-submit-icon' ); ?>>
										<i class="<?php echo esc_attr( $settings['button_icon'] ); ?>"></i>
									</span>
								<?php endif; ?>
								<span <?php echo $this->get_render_attribute_string( 'field-submit-text' ) ; ?>>
