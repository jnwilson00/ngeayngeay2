...
define( 'ELEMENTOR_EXTRAS_VERSION', 						'2.1.1' );
define( 'ELEMENTOR_EXTRAS_ELEMENTOR_VERSION_REQUIRED', 		'2.5.0' );
define( 'ELEMENTOR_EXTRAS_ELEMENTOR_PRO_VERSION_REQUIRED', 	'2.5.0' );
...
function elementor_extras_updater() {
	...
	$updater = new Namogo_Updater( NAMOGO_STORE_URL, __FILE__, $args );
}
