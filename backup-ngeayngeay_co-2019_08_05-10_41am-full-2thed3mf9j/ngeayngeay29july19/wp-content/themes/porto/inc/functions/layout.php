...
function porto_mobile_currency_switcher() {
	...
	if ( ! $porto_settings['wcml-switcher'] && has_nav_menu( 'currency_switcher' ) ) :
		wp_nav_menu(
			array(
				'theme_location' => 'currency_switcher',
				'container'      => '',
				'menu_class'     => 'currency-switcher porto-view-switcher accordion-menu show-arrow',
				'before'         => '',
				'after'          => '',
				'depth'          => 2,
				'link_before'    => '',
	...
	if ( $porto_settings['wcml-switcher'] && class_exists( 'WCML_Multi_Currency' ) ) {
		global $sitepress, $woocommerce_wpml;
		...
		?>
		<ul id="menu-currency-switcher" class="currency-switcher porto-view-switcher accordion-menu show-arrow">
			<li class="menu-item<?php echo ! $other_c ? '' : ' has-sub'; ?> narrow">
				<a class="nolink" href="#"><?php echo wp_kses_post( $active_c ); ?></a>
				<?php if ( $other_c ) : ?>
		...
		<?php
	} elseif ( $porto_settings['wcml-switcher'] && class_exists( 'WOOCS' ) ) {
		global $WOOCS;
		$currencies       = $WOOCS->get_currencies();
		$current_currency = $WOOCS->current_currency;
...
function porto_search_form() {
	...
	ob_start();
	?>
	<div class="searchform-popup<?php echo isset( $porto_settings['search-layout'] ) && ( 'simple' == $porto_settings['search-layout'] || 'large' == $porto_settings['search-layout'] || 'reveal' == $porto_settings['search-layout'] ) ? ' search-popup' : ''; ?>">
		<a class="search-toggle"><i class="fas fa-search"></i><span class="search-text"><?php esc_html_e( 'Search', 'porto' ); ?></span></a>
...
function porto_search_form_content() {
	...
	<form action="<?php echo esc_url( home_url() ); ?>/" method="get"
		...
		<div class="searchform-fields">
			...
			<?php if ( 'reveal' == $porto_settings['search-layout'] ) : ?>
